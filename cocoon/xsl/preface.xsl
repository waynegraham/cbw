					...
					<div id="top-container">
						<div id="featured-container">
							<ul id="featured" class="jcarousel-skin-tango">
								...
								<li><img src="full/no382.jpg" width="300" height="430" alt="" /><div class="featured-cap"><a href="featured?id=MADAME_DE_STAEL">Madame de Staël</a>, preeminent woman writer, heroine of the French Revolution.</div></li>
