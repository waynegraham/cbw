					...
					<div id="top-container">
						<div id="featured-container">
							<ul id="featured" class="jcarousel-skin-tango">
								...
								<li><img src="full/no425.jpg" width="280" height="430" alt="" /><div class="featured-cap"><a href="featured?id=LADY_JANE_GREY">Lady Jane Grey, queen regnant of England for less than two weeks, too little time to become a blameworthy ruling woman.</a></div></li>
								...
								<li><img src="full/no01.jpg" width="328" height="443" alt="" /><div class="featured-cap"><a href="featured?id=QUEEN_ELIZABETH_I">Queen Elizabeth I</a></div></li>
								<li><img src="full/no450.jpg" width="280" height="430" alt="" /><div class="featured-cap"><a href="featured?id=MADAME_ROLAND">Madame Roland</a>stands as great woman writer and heroine in prison scene: a protagonist of the French Revolution.</div></li>
								<li><img src="full/no416.jpg" width="280" height="430" alt="" /><div class="featured-cap"><a href="featured?id=POCAHONTAS">Pocahontas</a> alone represents Native Americans in these books, and joins others as leader's daughter, Christian convert, and rescuer of a man.</div></li>
								...
								<li><img src="full/no409.jpg" width="280" height="430" alt="" /><div class="featured-cap"><a href="featured?id=JENNY_LIND">Jenny Lind</a> was world-famous as "the Swedish Nightingale," opera singer who rose from the people.</div></li>
