					...
					<div id="top-container">
						<div id="featured-container">
							<ul id="featured" class="jcarousel-skin-tango">
								...
								<li><img src="full/no319.jpg" width="300" height="430" alt="" /><div class="featured-cap"><a href="featured?id=MARY_SOMERVILE"><xsl:value-of select="//div1[@id='MARY_SOMERVILLE']/head/note[@type='caption']/name"/></a><xsl:value-of select="//div1[@id='MARY_SOMERVILLE']/head/note[@type='caption']/text()"/></div></li>
								...
								<li><img src="full/no01.jpg" width="330" height="443" alt="" /><div class="featured-cap"><a href="featured?id=QUEEN_ELIZABETH_I"><xsl:value-of select="//div1[@id='QUEEN_ELIZABETH_I']/head/note[@type='caption']/name"/></a><xsl:value-of select="//div1[@id='QUEEN_ELIZABETH_I']/head/note[@type='caption']/text()"/></div></li>
