					...
					<div id="top-container">
						<div id="featured-container">
							<ul id="featured" class="jcarousel-skin-tango">
								...
								<li><img src="full/no240.jpg" width="300" height="430" alt="" /><div class="featured-cap"><a href="featured?id=HANNAH MORE"><xsl:value-of select="//div1[@id='HANNAH_MORE']/head/note[@type='caption']/name"/></a><xsl:value-of select="//div1[@id='HANNAH_MORE']/head/note[@type='caption']/text()"/></div></li>
								...
								<li><img src="full/no435.jpg" width="330" height="443" alt="" /><div class="featured-cap"><a href="featured?id=FRANCES_TROLLOPE"><xsl:value-of select="//div1[@id='FRANCES_TROLLOPE']/head/note[@type='caption']/name"/></a><xsl:value-of select="//div1[@id='FRANCES_TROLLOPE']/head/note[@type='caption']/text()"/></div></li>
								...
								<li><img src="full/no401.jpg" width="300" height="430" alt="" /><div class="featured-cap"><a href="featured?id=CHARLOTTE_BRONTE"><xsl:value-of select="//div1[@id='CHARLOTTE_BRONTE']/head/note[@type='caption']/name"/></a><xsl:value-of select="//div1[@id='CHARLOTTE_BRONTE']/head/note[@type='caption']/text()"/></div></li>
