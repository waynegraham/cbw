...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template name="header">
		...
		<div id="head">
			<table id="headTop" style="margin: 10px">
				<tr>
			...
			<h2 id="byline" style="position:relative; left: 630px; margin-top: -20px"><i>Alison Booth</i></h2>
			<div style="background:transparent url(banner_border.jpg) repeat-x scroll left bottom; width: 780px; height: 20px;">
			</div>
			<p id="subheading" style="font-size:10pt; margin-left: 10px;"><i>Includes Volumes of Three or More Female Biographies Published in English 1830-1940 &#149; With a Select Chronological Bibliography Prior to 1830</i></p>
		</div>
		<hr/>
